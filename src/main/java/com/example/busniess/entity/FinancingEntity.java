...
public class FinancingEntity {
    ...
    @NotBlank(message = "项目周期不能为空", groups = {UserValidator.UpDate.class, UserValidator.InSet.class})
    ...
    @NotBlank(message = "所占时间不能为空", groups = {UserValidator.UpDate.class, UserValidator.InSet.class})
