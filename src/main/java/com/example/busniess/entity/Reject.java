...
public class Reject implements Serializable {
    ...
    @NotNull(message = "关联企业信息id不能为空", groups = {UserValidator.UpDate.class,UserValidator.InSet.class})
    private Integer bId;//关联的企业认证信息id
    @NotNull(message = "关私人信息id不能为空", groups = {UserValidator.UpDate.class,UserValidator.InSet.class})
